...
#: |  #  | ASTM Field # | ASTM Name                       | Python alias      |
#: +=====+==============+=================================+===================+
#: |   1 |       11.1.1 |             ASTM Record Type ID |              type |
#: +-----+--------------+---------------------------------+-------------------+
#: |   2 |       11.1.2 |                 Sequence Number |               seq |
#: +-----+--------------+---------------------------------+-------------------+
#: |   3 |       11.1.3 |        Starting Range ID Number |          start_id |
#: +-----+--------------+---------------------------------+-------------------+
#: |   4 |       11.1.4 |           Ending Range ID Numbe |            end_id |
#: +-----+--------------+---------------------------------+-------------------+
#: |   5 |       11.1.5 |               Universal Test ID |              test |
#: +-----+--------------+---------------------------------+-------------------+
#: |   6 |       11.1.6 |   Nature of Request Time Limits |            limits |
#: +-----+--------------+---------------------------------+-------------------+
#: |   7 |       11.1.7 | Beginning Request Results Date  |      requested_at |
#: |     |              | and Time                        |                   |
#: +-----+--------------+---------------------------------+-------------------+
#: |   8 |       11.1.8 | Ending Request Results Date and |         ending_at |
#: |     |              | Time                            |                   |
#: +-----+--------------+---------------------------------+-------------------+
#: |   9 |       11.1.9 |       Requesting Physician Name |         physician |
#: +-----+--------------+---------------------------------+-------------------+
#: |  10 |      11.1.10 |  Requesting Physician Phone No. |   physician_phone |
#: +-----+--------------+---------------------------------+-------------------+
#: |  11 |      11.1.11 |                 User Field No.1 |      user_field_1 |
#: +-----+--------------+---------------------------------+-------------------+
#: |  12 |      11.1.12 |                 User Field No.2 |      user_field_2 |
#: +-----+--------------+---------------------------------+-------------------+
#: |  13 |      11.1.13 |       Request Info Status Codes |            status |
#: +-----+--------------+---------------------------------+-------------------+
#:
RequestRecord = Record.build(
    ConstantField(name='type', default='Q'),
    IntegerField(name='seq', default=1, required=True),
    NotUsedField(name='start_id'),
    NotUsedField(name='end_id'),
    NotUsedField(name='test'),
    NotUsedField(name='limits'),
    NotUsedField(name='requested_at'),
    NotUsedField(name='ending_at'),
...
#: |  #  | ASTM Field # | ASTM Name                       | Python alias      |
#: +=====+==============+=================================+===================+
#: |   1 |       10.5.1 |                  Record Type ID |              type |
#: +-----+--------------+---------------------------------+-------------------+
#: |   2 |       10.5.2 |                 Sequence Number |               seq |
#: +-----+--------------+---------------------------------+-------------------+
#: |   3 |       10.5.3 |                  Comment Source |            source |
#: +-----+--------------+---------------------------------+-------------------+
#: |   4 |       10.5.4 |                    Comment Text |              data |
#: +-----+--------------+---------------------------------+-------------------+
#: |   5 |       10.5.5 |                    Comment Type |             ctype |
#: +-----+--------------+---------------------------------+-------------------+
#:
